...
public static class ReportTools
{
    ...
    /// <summary>
    /// Generates a styled HTML report with embedded chart iframes.
    /// </summary>
    public static string GenerateHtmlReport(string title, string content)
    {
        ...
        {
            sb.AppendLine("<h2>📈 Interactive Charts</h2>");
        ...
        sb.AppendLine($"<div class='footer'>Report generated by Portfolio Optimizer — GitHub Copilot SDK + MAF</div>");
    ...
    /// <summary>
    /// Generates a PDF report via pandoc + typst. Returns null if pandoc is unavailable.
    /// </summary>
