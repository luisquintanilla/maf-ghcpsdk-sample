...
internal static class OptimizationTools
{
    ...
    public static string RenderFrontierChart()
    {
        ...
        var interpretation = $"This chart shows the efficient frontier — the best possible " +
            ...
            $"The frontier shows you could potentially earn more return at the same risk level, " +
            $"or take less risk for the same return, by optimizing your asset allocation.";
